...
btntimes = Button(mansLogs, text="x", padx="40", pady="20", command=lambda: btnCommand("*"))  
btnequal = Button(mansLogs, text="=", padx="40", pady="20", command=vienads)
...
btnsquere = Button(mansLogs, text="x²", padx="40", pady="20") 
